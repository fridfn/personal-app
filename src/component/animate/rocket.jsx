...
const StyledWrapper = styled.div`
  ...
  .rocket .rocket-body .body {
    ...
    border-top: 5px solid var(--primary-color-text);
  }
  ...
  .rocket .window {
    ...
    left: calc(50% - 25px);
    top: 40px;
    border: 5px solid var(--description-text-second);
  }
  ...
  .rocket .exhaust-flame {
    ...
    top: 90%;
    width: 28px;
    background: linear-gradient(to bottom, transparent 10%, var(--primary-color-text) 100%);
    height: 150px;
    left: calc(50% - 14px);
  ...
  @keyframes exhaust {
    0% {
      background: linear-gradient(to bottom, transparent 10%, #f5f5f5);
    }

    50% {
      background: linear-gradient(to bottom, transparent 8%, var(--primary-color-text) 100%);
    }

    75% {
      background: linear-gradient(to bottom, transparent 12%, var(--primary-color-text) 100%);
    }
  }
